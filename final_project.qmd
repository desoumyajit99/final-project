...
ggsave("econ_edu_density.png", plot = econ_edu_dp, width = 10, height = 10, dpi = 300)
...
ed_pvt_sc <- pvt_d %>%
                      ...
                      geom_point(alpha = 0.3, aes(color = EduPercent), size = 0.5) +
                      geom_smooth(method = "loess", se = FALSE, color = "black") +
...
wm_pvt_sc <- pvt_d %>% 
                        ...
                        geom_point(alpha = 0.5, aes(color = propWomen)) +
                        geom_smooth(method = "loess", se = FALSE, color = "black") +
...
pr_pvt_sc <- pvt_d %>%
                      ...
                      geom_point(alpha = 0.5, aes(color = Percent)) +
                      geom_smooth(method = "loess", se = FALSE, color = "black") +
...
pe_pvt_sc <- pvt_d %>%
                    pivot_longer(all_of(sector_vars), names_to = "Sector", values_to = "Percent") %>%
                    ggplot(aes(x = Percent, y = Poverty)) +
                    geom_point(alpha = 0.3, aes(color = Percent), size = 0.5) +
                    geom_smooth(method = "loess", se = FALSE, color = "black") +
...
pop_pvt_ss <- pvt_d %>% 
                        ...
                        geom_point(alpha = 0.3, aes(color = TotalPop), size = 0.5) +
